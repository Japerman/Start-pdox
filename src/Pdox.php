...
class Pdox implements PdoxInterface
{
    ...
    public function __construct(array $config)
    {
        ...
        $this->prefix_indexes = (isset($config['prefix_indexes']) ? $config['prefix_indexes'] : '');
        $this->strict = (isset($config['strict']) ? $config['strict'] : '');
